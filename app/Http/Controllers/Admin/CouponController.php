...
class CouponController extends Controller
{
    ...
    {	
		...
		$coupon=Coupon::orderby('cid','DESC')->paginate(50);
		
        return view('admin.coupon.index',array('items'=>$coupon)); 
    }
    ...
    public function store(Request $request)
    {
      ...
      $records['code'] = strtoupper($request->code);
	    ...
	    return \Redirect::route('admin_coupon')->with('message', 'Coupon Added Successfully ! '); 
    ...
    public function edit($id)
    {
        ...
        return view('admin.coupon.edit',array('item'=>$coupon));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // redirect
        return \Redirect::route('admin_coupon_edit',array('id' => $id))->with('message', 'Successfully Updated!');
    ...
    public function destroy($id)
    {
		...
		Coupon::Destroy($id);
	   	   return \Redirect::route('admin_coupon')->with('message', 'Successfully Deleted!');
